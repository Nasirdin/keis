...
const AddNews = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      const response = await axios.post(`${APILINK}/news/add`, formData);
  ...
  const removeItem = async (id) => {
    try {
      const response = await axios.delete(`${APILINK}/news/${id}`);
  ...
  return (
    <div className="admin-forms">
      ...
      >
        ...
        <button type="submit" className="admin-forms__btn">
          Добавить Новости
        </button>
      </form>
